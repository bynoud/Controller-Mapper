...
//            .setTitle("Pairing Information")
//            .setCancelable(false)
//            .setView(R.layout.dialog_pair)
//
//        badAbiDialog = MaterialAlertDialogBuilder(this)
//            .setTitle("Unsupported device")
//            .setMessage("You device is unsupported because it's 32bits and run Android 11+")
...
//        intent.type = ""
//
//        Snackbar.make(output, "Executing script from file", Snackbar.LENGTH_SHORT)
//            .setAction("Dismiss") {}
//            .show()
//
